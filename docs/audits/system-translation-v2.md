...
**Related docs:**  
`docs/CURRENT_STATE.md`, `docs/audits/user-profile-engine-design.md`, `docs/audits/benefits-simulator-design.md`, `docs/contracts/benefits-simulator-ui-contract.md`
...
**Recommendation:** Evolve `system-translation` into `system-understanding` (or v2 under same ID with breaking output schema). Store knowledge as a **concept graph** in `@arrivalos/shared-services/knowledge`, not as a flat glossary array.
...
| Layer | Store | Format |
|-------|-------|--------|
| **Graph data** | `@arrivalos/shared-services/knowledge/graph/` | JSON / YAML per domain |
...
New subsystem: `@arrivalos/shared-services/knowledge`
...
| Knowledge store? | Graph in `@arrivalos/shared-services/knowledge` |
