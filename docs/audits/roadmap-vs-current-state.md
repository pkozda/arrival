...
**Date:** 2026-06-18  
**Roadmap:** [mrc-6-to-platform-roadmap.md](../architecture/mrc-6-to-platform-roadmap.md) v1.0 (Status: Proposed, June 2026)  
**Current state:** Post Phase 5C — **UI READY**  
**Verification sources:** [platform-readiness-audit.md](./platform-readiness-audit.md), [ui-ready-gate-audit.md](./ui-ready-gate-audit.md), monorepo test run 439/439 green
...
| **Phase 1** — Product Contract | UI-safe / module-safe contracts | ✅ **100%** | `@arrivalos/product-contract`, all endpoints |
...
|------------------|---------|--------|----------|
| `@arrivalos/module-sdk` | defineModule, defineAction, … | ✅ | 8/8 tests |
...
| **G2** | No core/runtime in web | ⚠️ `@arrivalos/core` in selectors | ✅ **PASS** (package.json clean; see warning W1) |
...
```text
UI Layer (pure — @arrivalos/product-contract only)
  ↓
...
Explainability Layer           reason-mapping/
  ↓
Product Contract Layer         @arrivalos/product-contract
  ↓
Module SDK                     @arrivalos/module-sdk
  ↓
Observability & Health         @arrivalos/observability (ops-only)
  ↓
...
| 5 | UI Ready gate audit | ✅ [ui-ready-gate-audit.md](./ui-ready-gate-audit.md) |
...
| `next.config.mjs` stale `@arrivalos/core` transpilePackages | — | ⚠️ Hygiene | Trivial fix |
