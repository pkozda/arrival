...
**Bound by:** [MRC ADL — Architecture Decision Layer](./mrc-adl-architecture-decision-layer.md) — all constraints inherited. On conflict, ADL wins.

**Aligns with:**

- [Module Runtime Contract v1.0 — Specification](./module-runtime-contract-v1-specification.md) §3.5, §3.9
...
| Flag | Variable |
|------|----------|
| `ENVELOPE` | `ARRIVALOS_MRC_ENVELOPE === 'true'` |
| `EXPLANATION` | `ARRIVALOS_MRC_EXPLANATION === 'true'` |
...
- [ ] `ActionItem` type in `@arrivalos/module-runtime` (replace `actions?: unknown`)
...
- Add `ARRIVALOS_MRC_ACTIONS` flag without ADL revision
...
This blueprint is the **authoritative execution specification** for MRC-4 implementation. It is subordinate to the [MRC ADL](./mrc-adl-architecture-decision-layer.md) and supersedes informal drafts.
