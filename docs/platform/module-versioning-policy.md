---
id: module-versioning-policy
title: Module Versioning Policy
...
Arrival Atlas modules are versioned with **semantic versioning** (`MAJOR.MINOR.PATCH`) and validated at bootstrap/CI time via `@arrival-atlas/module-sdk`.
