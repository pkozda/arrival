...
| Package | Role | Files |
|---------|------|-------|
| `@arrivalos/core` | Platform layer | 6 |
| `@arrivalos/shared-services` | Reusable engines | 4 |
| `@arrivalos/modules` | Feature plugins | 6 |
| `@arrivalos/api` | HTTP server | 1 |
| `@arrivalos/web` | UI | 15 |
...
- Each module only depends on `@arrivalos/core` and `@arrivalos/shared-services`
