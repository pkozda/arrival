---
id: user-profile-engine-policy-layer-report
title: User Profile Engine Policy Layer Report
...
**Follows:** `docs/archive/user-profile-engine/runtime-unification-report.md`  
...
### New subsystem: `@arrival-atlas/profile/policy`
...
# Policy tests only
npm run test -w @arrival-atlas/profile -- src/policy
```
