---
id: user-profile-engine-ui-contract-report
title: User Profile Engine UI Contract Report
...
**Follows:** `docs/archive/user-profile-engine/execution-trace-report.md`  
**Status:** Complete
...
| `docs/archive/user-profile-engine/ui-contract-report.md` | This report |
...
| Suite | Tests | New |
|-------|-------|-----|
| `@arrival-atlas/profile` | 23 | +1 mapper test |
| `@arrival-atlas/api` | 3 | +2 boundary tests |
| **Total** | **57** | **+3** |
