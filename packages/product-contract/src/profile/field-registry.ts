...
export const PERSISTENT_FACT_FIELD_IDS = [
  ...
  'savingsDepleted',
  'benefitReportingOverdue',
  'benefitApplicationIntent',
  'daysInGermany',
  'preferredLanguage',
  'theme',
  'uiDensity',
